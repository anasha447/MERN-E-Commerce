      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="relative">
          <div className="flex overflow-hidden justify-center items-center space-x-8">
            {/* Arrow Buttons */}
            <button onClick={goToPrevious} className="flex-shrink-0 bg-white/80 p-2 rounded-full shadow-md hover:bg-white z-10">
              &lt;
            </button>
            ...
            <button onClick={goToNext} className="flex-shrink-0 bg-white/80 p-2 rounded-full shadow-md hover:bg-white z-10">
              &gt;
            </button>
          </div>
          ...
          <div className="flex justify-center mt-8">
            {products.map((_, index) => (
              <button
                ...
                className={`h-3 w-3 rounded-full mx-1 transition-colors duration-300 ${currentIndex === index ? 'bg-gray-800' : 'bg-gray-400 hover:bg-gray-600'}`}
              ></button>
            ))}
          </div>
        </div>
